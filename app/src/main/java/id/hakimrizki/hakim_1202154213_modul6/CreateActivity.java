package id.hakimrizki.hakim_1202154213_modul6;
...
import id.hakimrizki.hakim_1202154213_modul6.model.User;
        ...
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (imageUri != null && !TextUtils.isEmpty(name)) {
                    ...
                    image.putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> uploadTask) {
                            ...
                            if (uploadTask.isSuccessful()) {
                                ...
                                Toast.makeText(CreateActivity.this, "Error : " + uploadTask.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                    ...
                    Toast.makeText(CreateActivity.this, "Please Fill the form and choose image", Toast.LENGTH_LONG).show();
                }
            }
